...
class Partie(tk.Tk):
    ...
    def fenetre(self):
        ...
        if self.atteindre_la_fin():
            ...
            self.bouton_retour_menu = tk.Button(self, text="Aléatoire", activebackground='cornflowerblue', height=3, width=15, command=lambda:[self.fenetre(), self.change_couleur(),self.change_niveau(21)], font=f).place(x = 660, y = 392)
    ...
    def update_nb_coup(self):
        ...
        self.nombre_coup = self.canv.create_text(388,668,text=str(self.compteur_coup),fill=self.x,font="Arial 26 roman bold")
        self.canv.grid(column=0, row=0, ipadx=5, ipady=5, sticky=tk.E+tk.N) #force la création de l'objet ?
